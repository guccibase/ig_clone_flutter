...
class _CreatePostScreenState extends State<CreatePostScreen> {
          ...
          return CupertinoActionSheet(
            ...
            actions: <Widget>[
              CupertinoActionSheetAction(
                ...
                onPressed: () => _handleImageFile(ImageSource.camera),
              ),
              CupertinoActionSheetAction(
                child: Text('Choose from Gallery'),
                onPressed: () => _handleImageFile(ImageSource.gallery),
              ),
            ],
  ...
  _handleImageFile(ImageSource source) async {
  ...
  _submit() async{
    ...
    Post post = Post(
      ...
      caption: _caption,
      likes: {},
      authoId: Provider.of<UserData>(context, listen: false).currentUserId,
